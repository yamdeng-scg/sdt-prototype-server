...
module.exports = function () {
    ...
    // 추가 테이블 자동 생성 되게끔
    // 일반 이벤트 로그 테이블 생성
    let infoEventLogTableCreateStr1 = 'CREATE TABLE IF NOT EXISTS `info_event_log_ch1` ( `id` BIGINT(20) NOT NULL AUTO_INCREMENT, `logDate` VARCHAR(255) NULL DEFAULT NULL, `kind` VARCHAR(255) NULL DEFAULT NULL, `value` INT(11) NULL DEFAULT NULL, `logical_identifier` INT(10) UNSIGNED NULL DEFAULT NULL, `channel_number` TINYINT(3) UNSIGNED NULL DEFAULT NULL, `group` TINYINT(3) UNSIGNED NULL DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    let infoEventLogTableCreateStr2 = 'CREATE TABLE IF NOT EXISTS `info_event_log_ch2` ( `id` BIGINT(20) NOT NULL AUTO_INCREMENT, `logDate` VARCHAR(255) NULL DEFAULT NULL, `kind` VARCHAR(255) NULL DEFAULT NULL, `value` INT(11) NULL DEFAULT NULL, `logical_identifier` INT(10) UNSIGNED NULL DEFAULT NULL, `channel_number` TINYINT(3) UNSIGNED NULL DEFAULT NULL, `group` TINYINT(3) UNSIGNED NULL DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    ...
    // 차트 정보 로그 테이블 생성
    let tripwaveLogTableCreateStr1 = 'CREATE TABLE IF NOT EXISTS `tripwave_log_ch1` ( `id` bigint(20) NOT NULL AUTO_INCREMENT, `logDate` varchar(255) DEFAULT NULL, `data` text DEFAULT NULL, `logical_identifier` int(10) unsigned DEFAULT NULL, `channel_number` tinyint(3) unsigned DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    let tripwaveLogTableCreateStr2 = 'CREATE TABLE IF NOT EXISTS `tripwave_log_ch2` ( `id` bigint(20) NOT NULL AUTO_INCREMENT, `logDate` varchar(255) DEFAULT NULL, `data` text DEFAULT NULL, `logical_identifier` int(10) unsigned DEFAULT NULL, `channel_number` tinyint(3) unsigned DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    ...
    // 원격 gcm 정보 테이블 생성
    let remoteGcmTableCreateStr = 'CREATE TABLE IF NOT EXISTS `remote_gcm` ( `logical_identifier` int(11) unsigned DEFAULT NULL, `channel_number` tinyint(4) unsigned DEFAULT NULL, `gcmkey` varchar(255) DEFAULT NULL, `register_id1` varchar(255) DEFAULT NULL, `register_id2` varchar(255) DEFAULT NULL, `register_id3` varchar(255) DEFAULT NULL, `register_id4` varchar(255) DEFAULT NULL, `register_id5` varchar(255) DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    dbService.executeQueryByStr(remoteGcmTableCreateStr);

    // 열화상 차트 테이블 생성 
    let cameraMonthTableCreateStr = 'CREATE TABLE IF NOT EXISTS `camera_temp_month` ( `channel_number` TINYINT(4) NULL DEFAULT NULL, `temp_date` VARCHAR(255) NULL DEFAULT NULL, `temp_value` FLOAT NULL DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    dbService.executeQueryByStr(cameraMonthTableCreateStr);
    let cameraWeekTableCreateStr = 'CREATE TABLE IF NOT EXISTS `camera_temp_week` ( `channel_number` TINYINT(4) NULL DEFAULT NULL, `temp_date` VARCHAR(255) NULL DEFAULT NULL, `temp_value` FLOAT NULL DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    dbService.executeQueryByStr(cameraWeekTableCreateStr);
    let cameraDayTableCreateStr = 'CREATE TABLE IF NOT EXISTS `camera_temp_day` ( `channel_number` TINYINT(4) NULL DEFAULT NULL, `temp_date` VARCHAR(255) NULL DEFAULT NULL, `temp_value` FLOAT NULL DEFAULT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8';
    dbService.executeQueryByStr(cameraDayTableCreateStr);

    // 테마, 다국어 정보 테이블 생성
    let localeTableCreateStr = 'CREATE TABLE IF NOT EXISTS `global_option_info` ( `theme` VARCHAR(50) NOT NULL, `locale` VARCHAR(50) NOT NULL ) engine=innodb DEFAULT charset=utf8';
    dbService.executeQueryByStr(localeTableCreateStr)
        .then(() => {
    ...
    // 관리자 정보 insert
    dbService.selectOne('gateway_user', 'id', CONFIG.ADMIN_INFO.id)
        .then((result) => {
            if (!result) {
    ...
    // setting_modbus_rtu
    dbService.select('setting_modbus_rtu')
        .then((result) => {
            if (result.length === 0) {
    ...
    dbService.selectQueryById('findSettingInfo', ['CloudInfo', 'Address'])
        .then((result) => {
            if (result.length === 0) {
    ...
    // ch1 error msg
    dbService.selectQueryById('findSettingInfo', ['ChErrorMsg', 'ch1'])
        .then((result) => {
            if (result.length === 0) {
                dbService.insert('setting_info', {
                    Category: 'ChErrorMsg',
    ...
    // ch2 error msg
    dbService.selectQueryById('findSettingInfo', ['ChErrorMsg', 'ch2'])
        .then((result) => {
            if (result.length === 0) {
                dbService.insert('setting_info', {
                    Category: 'ChErrorMsg',
    ...
    // eth error msg
    dbService.selectQueryById('findSettingInfo', ['ChErrorMsg', 'eth'])
        .then((result) => {
            if (result.length === 0) {
                dbService.insert('setting_info', {
                    Category: 'ChErrorMsg',
